class AirlineReservationSystem
{
    ...
    static List<int> flightCount = new List<int>();
    ...
    static List<int> bookingCount = new List<int>();
    ...
    static void AddFlight(string flightCode, string fromCity, string toCity, DateTime departureTime, int duration, int price)
    {
        ...
        if (flightCount.Count < MaxFlights)
        {
    ...
    public static void CancelFlightBooking(out string canceld)
    {
        ...
        for (int i = 0; i < bookingCount.Count; i++)
        {
    ...
    {
        if (bookingCount.Count < MaxBookings) //check if booking limit is reached
        {
    ...
    static string GenerateBookingID(string passengerName)
    {
        ...
        string bookingID =  (bookingCount.Count + 1).ToString();
        return bookingID;
